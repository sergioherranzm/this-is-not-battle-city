...
export class EnemyTankStandard extends EnemyTank {
  constructor(position: Point, angle: number) {
    super(position, angle, 1, sprite_standard_1, sprite_standard_2, 100, 1);
  }
}

export class EnemyTankHeavy extends EnemyTank {
  constructor(position: Point, angle: number) {
    super(position, angle, 5, sprite_heavy_1, sprite_heavy_2, 60, 1);
  }
}

export class EnemyTankRapid extends EnemyTank {
  constructor(position: Point, angle: number) {
    super(position, angle, 1, sprite_rapid_1, sprite_rapid_2, 150, 1);
  }
}

export class EnemyTankStrong extends EnemyTank {
  constructor(position: Point, angle: number) {
    super(position, angle, 2, sprite_strong_1, sprite_strong_2, 80, 2);
  }
}
